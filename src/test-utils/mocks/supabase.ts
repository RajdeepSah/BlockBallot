...
export function createMockGetServiceRoleClient() {
  return jest.fn<typeof import('@/utils/supabase/clients').getServiceRoleClient>().mockReturnValue(
    createMockSupabaseClient() as ReturnType<typeof import('@/utils/supabase/clients').getServiceRoleClient>
  );
}
...
export function createMockGetAnonServerClient() {
  return jest.fn<typeof import('@/utils/supabase/clients').getAnonServerClient>().mockReturnValue(
    createMockSupabaseClient() as ReturnType<typeof import('@/utils/supabase/clients').getAnonServerClient>
  );
}
